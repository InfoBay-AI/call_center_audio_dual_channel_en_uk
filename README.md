# call_center_audio_dual_channel_en_uk
**Dataset Description:**

This dataset is a **large-scale collection of raw English (UK) call center audio (dual-channel)**, designed to support the development and training of advanced speech and AI systems.
